...
Open CMD
Open the directory where you .exe release is present (C:\Qt\Projects\TCPClient\build\Desktop_Qt_6_7_3_MinGW_64_bit-Release\release).
Run the command $ windeployqt <Program.exe> (windeployqt TCPClient.exe)
